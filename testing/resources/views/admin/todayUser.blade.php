        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('admin.panel') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="adminAssets/images/Logo.png" alt="" height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('today.visitors') }}" class="nav-link"> Today's Users
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('total.visitors') }}" class="nav-link"> Total Users
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Today's Users</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-3">
                                            ...
                                            <tbody>
                                                @foreach ($todayLogs as $user)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('block.visitor', $user->id) }}"
