        ...
        <section class="shock-section has-overlay pb-5">
            <div class="banner">
                ...
                <div class="image-wrapper">
                    <img src="assets/images/jpg/a-41.jpg" class="image vh-75 fit-cover"
                    ...
                    <div class="col-12 col-md-6 align-v-start order-2 order-md-1">
                        ...
                        <div class="collapsible mt-35">
                            <div class="collapse-group">
                                <a href="#collapse-1" class="collapse-toggle parent" aria-expanded="true"
                                ...
                                <div id="collapse-1" class="collapse-content collapse show">
                                    <p>Because a class called <mark
                                            class="animated-underline accent text-black">show</mark> was set in the
                                        html and thus it stays open when loading the page.</p>
                                    <p>This is certainly useful to keep the most important question and answer
                                        highlighted.</p>
                                </div>
                            </div>
                            <div class="collapse-group">
                                ...
                                <div id="collapse-2" class="collapse-content collapse">
                                    <p>To get this highlighted text, <mark
                                            class="animated-underline accent text-black">just use the html mark
                                            tag</mark>, and use a color class. 😃</p>
                                    <p>Also works well with <mark
                                            class="animated-underline primary-50 text-black">other colors</mark> by
                                        adding a color class to the element, but use it sparingly or it may become
                                        exaggerated.</p>
                                </div>
                            </div>
                            <div class="collapse-group">
                                ...
                                <div id="collapse-3" class="collapse-content collapse">
                                    <p>Yea! 😍</p>
                                    <p>This theme was made to make it easier to build any type of website. Also the item
                                        support is very friendly and professional.</p>
                                    ...
                                    <div class="form-row row">
                                        <div class="form-col col-12">
                                            <div class="form-check">
                                                <input type="radio" name="info" id="InputRadio1"
                                                    class="form-check-input form-radio" checked="checked"
                                                    value="I found this site by searching the internet."
                                                    required="required">
                                        ...
                                        <div class="form-col col-12">
                                            <div class="form-check">
                                                <input type="radio" name="info" id="InputRadio2"
                                                    class="form-check-input form-radio primary"
                                                    value="A friend recommended this site to me." required="required">
                                    ...
                                    <ul class="icon-h-list">
                                        <li class="item">
                                            <a href="#your-link" target="_blank"
                                                class="link black primary-hover hover-rotate"><i
