...
<body class="shock-body">
    ...
    <header id="header" class="shock-header">
        <!-- Navbar -->
        <nav id="navbar"
            class="navbar navbar-expand-lg fixed-scroll hover-line-center scheme-1 primary navbar-sticky">
            <div class="container">
                <!-- Brand -->
            ...
            <div class="container">
                ...
                <div class="basic-intro mb-35 text-center">
                    <h1 class="title text-style-3">
                        <span class="text-1 text-outline black-75">Privacy</span>
                        <span class="text-2 text-italic black"><mark
                                class="animated-underline primary">Policy</mark>.</span>
                    </h1>
                    <hr class="gray-25">
                </div>
            </div>
